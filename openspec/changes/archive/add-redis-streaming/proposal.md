...
**Reason**: This change was superseded by the more comprehensive "refactor-redis-pubsub-to-stream" which provides Redis Stream persistence instead of just Pub/Sub, offering better message durability and subscription resumption capabilities.
...
## Migration to refactor-redis-pubsub-to-stream

This change's core functionality has been integrated into **refactor-redis-pubsub-to-stream**, which provides:
- ✅ Redis Stream persistence (XADD/XREAD/XRANGE)
- ✅ Automatic message cleanup (XTRIM)
- ✅ Subscription resumption with last_id
- ✅ Complete history recovery after page refresh
- ✅ Better reliability and durability

See `openspec/changes/refactor-redis-pubsub-to-stream/` for the current implementation.
